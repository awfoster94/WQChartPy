...
def plot(df, 
    ...
    plt.legend(bbox_to_anchor=(1.225, 1.015), markerscale=1, fontsize=10,
    ...
    axins.axis('off')
    ax1.text(0.825, 1.35, 'Silicates', fontsize=12)
    ...
    axins.add_patch(ellipse)
    axins.axis('off')
    ax1.text(20, 40, 'Carbonates', fontsize=12)

    # Set the labels and ticks
    ax1.set_xlabel('$\dfrac{Ca^{2+}}{Na^+}$', fontsize=12, weight='normal')
    ax1.set_ylabel('$\dfrac{HCO_3^-}{Na^+}$', fontsize=12, weight='normal')
    ...
    axins.add_patch(ellipse)
    axins.axis('off')
    ax2.text(0.8, 0.2, 'Silicates', fontsize=12)
    ...
    axins.add_patch(ellipse)
    axins.axis('off')
    ax2.text(20, 3.5, 'Carbonates', fontsize=12)
    
    # Set the lables and ticks
    ax2.set_xlabel('$\dfrac{Ca^{2+}}{Na^+}$', fontsize=12, weight='normal')
    ax2.set_ylabel('$\dfrac{Mg^{2+}}{Na^+}$', fontsize=12, weight='normal')
