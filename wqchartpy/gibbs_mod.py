...
def plot(df, 
    ...
    ax1.set_xlabel('$\dfrac{Na^+}{Na^++Ca^{2+}}$', weight='normal',
               fontsize=12)
    ax1.set_ylabel('TDS  ($\dfrac{mg}{L}$)', weight='normal',
                   fontsize=12)
    ...
    ax2.text(0.76, 8.5,'Rainfall', fontname='Times New Roman',
             fontsize=12)
    ax2.text(0.025, 135, 'Rock \nDominancy', va='center',
             fontname='Times New Roman', fontsize=12)
    ax2.text(0.72, 7000,'Seawater', fontname='Times New Roman',
             fontsize=12)
    
    ax2.set_xlabel('$\dfrac{Cl^-}{Cl^-+HCO_3^-}$', 
                   weight='normal', fontsize=12)
    ax2.set_ylabel('TDS  ($\dfrac{mg}{L}$)',
    ...
    # Create the legend
    plt.legend(bbox_to_anchor=(1.05, 1.01), markerscale=1,
